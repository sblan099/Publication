...
# deletion of the columns for active defensive behaviours, shell emergence, total time spent moving, and time of initial movement (and log transformed version)
...
# deletion of the columns for active defensive behaviours, shell emergence (and the binary version), total time spent moving, and the log transformed version of time of initial movement
...
# deletion of the columns for active defensive behaviours, shell emergence (and the binary version), total time spent moving, and the time of initial movement
...
# deletion of the columns for active defensive behaviours, shell emergence (and the binary version), and the time of initial movement (and the log transformed version)
...
cor.behaviour <- cor[,c(3,5,6,7,8)]
chart.Correlation(cor.behaviour, histogram=TRUE, pch=19)
```
```{r}
# Creation of the correlation table
table.corr.pearson.behaviour <- rcorr(as.matrix(cor[,c(3,5,6,7,8)]), type="pearson")
...
```{r}
# Creation of the correlation table
table.corr.spearman.behaviour <- rcorr(as.matrix(cor[,c(3,5,6,7,8)]), type="spearman")
